...
public class ExecuteService implements ServiceDefinition {

  private final @NotNull CommonResources commonResources;

  public ExecuteService(final @NotNull CommonResources commonResources) {
  ...
  public @NotNull ServiceDescriptor getDefaultDescriptor() {
    return new ServiceDescriptor(
        ...
        List.of(
          ...
          new ServiceProperty("runInTerminal", "true", false, PropertyType.BOOLEAN),
          new ServiceProperty("command", "ping $address", true, PropertyType.STRING)));
  }
