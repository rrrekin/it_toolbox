...
public class GenericNodeEditor extends JDialog {
  ...
  public static void main(String[] args) {
    GenericNodeEditor dialog = new GenericNodeEditor();
    dialog.pack();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    ...
    panel3.add(textField1, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST,
